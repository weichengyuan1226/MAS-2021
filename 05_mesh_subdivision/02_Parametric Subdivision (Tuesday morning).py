...
#my_sphere = msd.mesh_subdivide_tapered(sphere_smooth, face_angles, fractions, doCaps)
my_sphere = msd.mesh_subdivide_tapered(sphere_smooth, 0.5, 0.5, False)

# turn into volume by offset
offset_sphere = msd.my_mesh_thicken(my_sphere, 0.1)
